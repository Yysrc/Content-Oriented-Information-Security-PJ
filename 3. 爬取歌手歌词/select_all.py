...
class CrawlerLyric:
    ...
    def get_all_song_lyric(self):
        ...
        with open('{}.txt'.format(self.singer_name), 'a', encoding='utf-8')as fp:
            print("ok")
...
if __name__ == "__main__":
    i = CrawlerLyric('刀郎','2517')
    i.get_all_song_lyric()
